...
public interface ArticleRepository extends ListCrudRepository<Article, Long> {
    ...
    // Per la ricerca utilizzeremo una query JPQL (Java Persistence Query Language) che renderà la ricerca facile da 
    // effettuare dato che recupererà solo i dati che corrispondono al parametro di ricerca che invieremo tramite il form
