...
public class OperationController {
    ...
    // Rotta per la creazione di una nuova richiesta di collaborazione
    ...
    // Rotta per il salvataggio della nuova richiesta di collaborazione
    ...
    // Rotta per l'accettazione della richiesta
