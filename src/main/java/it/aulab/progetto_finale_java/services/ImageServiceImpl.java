...
public class ImageServiceImpl implements ImageService{
    ...
    //  rende asincroni, questo vuol dire che non andranno ad appesantire il flusso del nostro progetto,  
    // poichè la memorizzazione e la cancellazione delle immagini dipendendo da un altro server. Se fossero sincroni potrebbero dare problemi di rallentamento.
@Async
    public CompletableFuture<String> saveImageOnCloud(MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            try{
                // Genera il nome del file unico
                ...
                // Costruzione dell'URL, verificare se gli slash siano corretti in application.properties
